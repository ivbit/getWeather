...
NR == 5 {
  gsub("heavy intensity rain","Ливень",$0)
  gsub("rain","дождь",$0)
  gsub("snow","снег",$0)
...
END {
  ...
  print "Давление:\t " myPressure "\tмм рт. ст."
  print "Скорость ветра:\t " myWind "\tм/с"
  if (myGust)
  {
    print "Порывы:\t\t " myGust "\tм/с"
  }
  print "Небо, осадки:\t " mySnowRain
